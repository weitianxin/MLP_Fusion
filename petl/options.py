...
class TuneArguments:
    ...
    distill: Optional[bool] = field(
        default=False,
        metadata={
            "help": "coefficient of distillation loss",
        },
    )

    load_clustering: Optional[bool] = field(
        default=False,
        metadata={
            "help": "whether load the pre-computed clustering results",
        },
    )

    approx_check: Optional[bool] = field(
        default=False,
        metadata={
            "help": "True to check the appoximation effects",
        },
    )

    approx_check_ntk: Optional[bool] = field(
        default=False,
        metadata={
            "help": "True to check the appoximation effects",
        },
    ...
    n_steps: Optional[str] = field(
        default=10,
        metadata={
            "help": "the number of optimization steps for mmd loss",
        },
    )
    ...
    sketch_layers: Optional[str] = field(
        default="0,1,2,3,4,5",
        metadata={
            "help": "decide the layers of MLP to sketch"
        },
    )

    re_init_layers: Optional[str] = field(
        default=" ",
        metadata={
            "help": "decide the layers to re-initialize"
        },
    )

    lr_sketch_factor: Optional[float] = field(
        default=-1,
        metadata={
            "help": "decide the learning rate for the sketched layers, \
                which is a multiple of the general lr"
        },
    )
